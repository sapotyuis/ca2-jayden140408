// Renders the login form, authenticates the player, and redirects to the camp after success.
import { createClassNames } from '../helpers/cssClassNames.js';
import { renderAuthShell } from './accountLayout.js';
...
export const renderLoginPage = ({ root, auth, worldClock }) => {
  ...
  const view = renderAuthShell({
    ...
    footer: `New player? <a href="/register">Create a survivor account.</a><br><a href="/leaderboard">View the public leaderboard.</a>`,
  });
