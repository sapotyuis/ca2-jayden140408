...
import { CSS_PALETTE_TOKENS, PHASE_PALETTES, RAMPS, applyAtmosphere, mixHex, resolvePhase } from '../../public/js/ocean/palette.js';

const tokensCss = readFileSync(fileURLToPath(new URL('../../public/css/tokens.css', import.meta.url)), 'utf8');
