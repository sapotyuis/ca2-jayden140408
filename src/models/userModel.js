...
export const findUserUpgradeTypes = async (userId, executor = db) => {
...
export const insertDebrisCollectionLog = async (data, executor = db) => {
 ...
 */
export const upgradeRaftAtomic = async (userId, newMaterials, newRaftSize, upgradeData, executor = db) => {
 ...
 */
export const claimQuestRewardAtomic = async ({ userQuestId, userId, newMaterials, rewardItemTypeId, rewardItemQuantity, executor = db }) => {
  const operation = async (tx) => {
