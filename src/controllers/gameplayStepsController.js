import { findItemTypeById, findItemTypesByIds } from '../models/itemTypeModel.js';
import { findAllCraftingRecipes } from '../models/craftingRecipeModel.js';
import { collectDebrisByIdAtomic } from '../models/debrisModel.js';
import { craftItemAtomic, findAllUserItems } from '../models/userItemModel.js';
import { findUserQuestByUserAndQuest, advanceQuestProgress } from '../models/userQuestModel.js';
import { findQuestById } from '../models/questModel.js';
import {
  claimQuestRewardAtomic,
  findUserUpgradeTypes,
  insertDebrisCollectionLog,
  upgradeRaftAtomic,
} from '../models/userModel.js';
import { findUnexpectedEventById, resolveUnexpectedEventAtomic } from '../models/unexpectedEventModel.js';
...
export const validateDebrisCollection = (req, res, next) => {
...
export const collectDebrisModelStep = useStep(async (req, res) => {
  const result = await collectDebrisByIdAtomic(
    req.user.user_id,
    res.locals.debrisId,
...
export const advanceDebrisQuestModelStep = useStep(async (req, res) => {
  res.locals.completedQuests = await advanceQuestProgress(
...
export const collectDebrisPipeline = transactionalPipeline(
  [validateDebrisCollection, collectDebrisModelStep, advanceDebrisQuestModelStep],
  { onError: recordRejectedCollection }
);

// Crafting -----------------------------------------------------------------

export const loadCraftingRecipesModelStep = useStep(async (req, res) => {
...
export const loadCraftResultItemModelStep = useStep(async (req, res) => {
...
export const loadCraftInventoryModelStep = useStep(async (req, res) => {
  res.locals.userInventory = await findAllUserItems({ user_id: req.user.user_id }, txOf(res));
});

export const loadCraftIngredientsModelStep = useStep(async (req, res) => {
...
export const validateCraftIngredients = (req, res, next) => {
  const inventoryMap = {};
...
export const saveCraftedItemModelStep = useStep(async (req, res) => {
  res.locals.craftedItem = await craftItemAtomic(
    req.user.user_id,
...
export const craftItemPipeline = transactionalPipeline([
  loadCraftingRecipesModelStep,
  loadCraftResultItemModelStep,
  loadCraftInventoryModelStep,
  loadCraftIngredientsModelStep,
  validateCraftIngredients,
  saveCraftedItemModelStep,
]);

// Raft upgrades ------------------------------------------------------------

export const loadInstalledUpgradesModelStep = useStep(async (req, res) => {
  ...
  const installedUpgrades = await findUserUpgradeTypes(req.user.user_id, txOf(res));
...
export const saveRaftUpgradeModelStep = useStep(async (req, res) => {
  res.locals.upgradeResult = await upgradeRaftAtomic(
    req.user.user_id,
...
export const raftUpgradePipeline = transactionalPipeline([
  loadInstalledUpgradesModelStep,
  saveRaftUpgradeModelStep,
]);

// Unexpected ocean events -------------------------------------------------

export const validateUnexpectedEvent = (req, res, next) => {
...
export const loadUnexpectedEventModelStep = useStep(async (req, res) => {
...
export const resolveUnexpectedEventModelStep = useStep(async (req, res) => {
  const result = await resolveUnexpectedEventAtomic({
...
export const advanceUnexpectedEventQuestModelStep = useStep(async (req, res) => {
  res.locals.completedQuests = await advanceQuestProgress(
...
export const unexpectedEventPipeline = transactionalPipeline([
  validateUnexpectedEvent,
  loadUnexpectedEventModelStep,
  resolveUnexpectedEventModelStep,
  advanceUnexpectedEventQuestModelStep,
]);

// Quest rewards ------------------------------------------------------------

export const validateQuestReward = (req, res, next) => {
...
export const loadQuestRewardModelStep = useStep(async (req, res) => {
...
export const loadUserQuestRewardModelStep = useStep(async (req, res) => {
...
export const saveQuestRewardModelStep = useStep(async (req, res) => {
  res.locals.questReward = await claimQuestRewardAtomic({
...
export const questRewardPipeline = transactionalPipeline([
  validateQuestReward,
  loadQuestRewardModelStep,
  loadUserQuestRewardModelStep,
  saveQuestRewardModelStep,
]);
